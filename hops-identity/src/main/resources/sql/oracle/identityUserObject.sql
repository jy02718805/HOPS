...
comment on column ACCOUNT_TYPE.ACCOUNT_TYPE_STATUS
  is '状态 1可用，0不可用。';
comment on column ACCOUNT_TYPE.TABLE_NAME
  is '表名';
comment on column ACCOUNT_TYPE.SUB_FLAG
  is '是否分表 0 不分表 1 分表';
comment on column ACCOUNT_TYPE.SUB_NUMBER
  is '分表数量';
...
comment on column CCY_ACCOUNT_BALANCE_HISTORY.CHANGE_AMOUNT
  is '变动金额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY.ACCOUNT_TYPE_ID
  is '账户类型ID';
alter table CCY_ACCOUNT_BALANCE_HISTORY
  add primary key (ID);

create table CCY_ACCOUNT_BALANCE_HISTORY_0
(
  ID                       NUMBER not null,
  TRANSACTION_ID           NUMBER,
  ACCOUNT_ID               NUMBER,
...
comment on column CCY_ACCOUNT_BALANCE_HISTORY_0.ID
  is '主键';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_0.TRANSACTION_ID
  is '交易ID';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_0.ACCOUNT_ID
  is '账户ID';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_0.NEW_AVAILABLE_BALANCE
  is '修改后可用余额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_0.NEW_UNAVAILABLE_BANLANCE
  is '修改后不可用余额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_0.NEW_CREDITABLE_BANLANCE
  is '修改后授信余额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_0.CREATE_DATE
  is '创建时间';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_0.TYPE
  is '日志类型';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_0.DESC_STR
  is '日志说明';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_0.IDENTITY_NAME
  is '用户名称';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_0.CHANGE_AMOUNT
  is '变动金额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_0.ACCOUNT_TYPE_ID
  is '账户类型ID';
alter table CCY_ACCOUNT_BALANCE_HISTORY_0
  add primary key (ID);

create table CCY_ACCOUNT_BALANCE_HISTORY_1
(
  ID                       NUMBER not null,
  TRANSACTION_ID           NUMBER,
  ACCOUNT_ID               NUMBER,
...
comment on column CCY_ACCOUNT_BALANCE_HISTORY_1.ID
  is '主键';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_1.TRANSACTION_ID
  is '交易ID';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_1.ACCOUNT_ID
  is '账户ID';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_1.NEW_AVAILABLE_BALANCE
  is '修改后可用余额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_1.NEW_UNAVAILABLE_BANLANCE
  is '修改后不可用余额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_1.NEW_CREDITABLE_BANLANCE
  is '修改后授信余额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_1.CREATE_DATE
  is '创建时间';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_1.TYPE
  is '日志类型';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_1.DESC_STR
  is '日志说明';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_1.IDENTITY_NAME
  is '用户名称';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_1.CHANGE_AMOUNT
  is '变动金额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_1.ACCOUNT_TYPE_ID
  is '账户类型ID';
alter table CCY_ACCOUNT_BALANCE_HISTORY_1
  add primary key (ID);

create table CCY_ACCOUNT_BALANCE_HISTORY_2
(
  ID                       NUMBER not null,
  TRANSACTION_ID           NUMBER,
  ACCOUNT_ID               NUMBER,
...
comment on column CCY_ACCOUNT_BALANCE_HISTORY_2.ID
  is '主键';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_2.TRANSACTION_ID
  is '交易ID';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_2.ACCOUNT_ID
  is '账户ID';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_2.NEW_AVAILABLE_BALANCE
  is '修改后可用余额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_2.NEW_UNAVAILABLE_BANLANCE
  is '修改后不可用余额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_2.NEW_CREDITABLE_BANLANCE
  is '修改后授信余额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_2.CREATE_DATE
  is '创建时间';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_2.TYPE
  is '日志类型';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_2.DESC_STR
  is '日志说明';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_2.IDENTITY_NAME
  is '用户名称';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_2.CHANGE_AMOUNT
  is '变动金额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_2.ACCOUNT_TYPE_ID
  is '账户类型ID';
alter table CCY_ACCOUNT_BALANCE_HISTORY_2
  add primary key (ID);

create table CCY_ACCOUNT_BALANCE_HISTORY_3
(
  ID                       NUMBER not null,
  TRANSACTION_ID           NUMBER,
  ACCOUNT_ID               NUMBER,
...
comment on column CCY_ACCOUNT_BALANCE_HISTORY_3.ID
  is '主键';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_3.TRANSACTION_ID
  is '交易ID';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_3.ACCOUNT_ID
  is '账户ID';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_3.NEW_AVAILABLE_BALANCE
  is '修改后可用余额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_3.NEW_UNAVAILABLE_BANLANCE
  is '修改后不可用余额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_3.NEW_CREDITABLE_BANLANCE
  is '修改后授信余额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_3.CREATE_DATE
  is '创建时间';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_3.TYPE
  is '日志类型';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_3.DESC_STR
  is '日志说明';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_3.IDENTITY_NAME
  is '用户名称';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_3.CHANGE_AMOUNT
  is '变动金额';
comment on column CCY_ACCOUNT_BALANCE_HISTORY_3.ACCOUNT_TYPE_ID
  is '账户类型ID';
alter table CCY_ACCOUNT_BALANCE_HISTORY_3
  add primary key (ID);
...
comment on column IDENTITY_ACCOUNT_ROLE.TABLE_NAME
  is '表名';
...
create table MERCHANT_CREDIT_ACCOUNT
(
  ACCOUNT_ID           NUMBER not null,
  STATUS               VARCHAR2(10),
  AVAILABLE_BALANCE    VARCHAR2(30),
...
comment on column MERCHANT_CREDIT_ACCOUNT.ACCOUNT_ID
  is '账户ID';
comment on column MERCHANT_CREDIT_ACCOUNT.STATUS
  is '状态';
comment on column MERCHANT_CREDIT_ACCOUNT.AVAILABLE_BALANCE
  is '可用余额';
comment on column MERCHANT_CREDIT_ACCOUNT.UNAVAILABLE_BANLANCE
  is '不可用余额';
comment on column MERCHANT_CREDIT_ACCOUNT.CREDITABLE_BANLANCE
  is '授信余额';
comment on column MERCHANT_CREDIT_ACCOUNT.ACCOUNT_TYPE_ID
  is '账户类型ID';
comment on column MERCHANT_CREDIT_ACCOUNT.RMK
  is '备注';
comment on column MERCHANT_CREDIT_ACCOUNT.LAST_UPDATE_USER
  is '最后更新人';
comment on column MERCHANT_CREDIT_ACCOUNT.LAST_UPDATE_DATE
  is '最后更新时间';
comment on column MERCHANT_CREDIT_ACCOUNT.CREATOR
  is '创建人';
comment on column MERCHANT_CREDIT_ACCOUNT.CREATE_DATE
  is '创建时间';
comment on column MERCHANT_CREDIT_ACCOUNT.SIGN
  is '签名';
comment on column MERCHANT_CREDIT_ACCOUNT.VERSION
  is '版本';
comment on column MERCHANT_CREDIT_ACCOUNT.HISTORY_ID
  is '流水号';
alter table MERCHANT_CREDIT_ACCOUNT
  add primary key (ACCOUNT_ID);

create table MERCHANT_DEBIT_ACCOUNT
(
  ACCOUNT_ID           NUMBER not null,
  STATUS               VARCHAR2(10),
  AVAILABLE_BALANCE    VARCHAR2(30),
...
comment on column MERCHANT_DEBIT_ACCOUNT.ACCOUNT_ID
  is '账户ID';
comment on column MERCHANT_DEBIT_ACCOUNT.STATUS
  is '状态';
comment on column MERCHANT_DEBIT_ACCOUNT.AVAILABLE_BALANCE
  is '可用余额';
comment on column MERCHANT_DEBIT_ACCOUNT.UNAVAILABLE_BANLANCE
  is '不可用余额';
comment on column MERCHANT_DEBIT_ACCOUNT.CREDITABLE_BANLANCE
  is '授信余额';
comment on column MERCHANT_DEBIT_ACCOUNT.ACCOUNT_TYPE_ID
  is '账户类型ID';
comment on column MERCHANT_DEBIT_ACCOUNT.RMK
  is '备注';
comment on column MERCHANT_DEBIT_ACCOUNT.LAST_UPDATE_USER
  is '最后更新人';
comment on column MERCHANT_DEBIT_ACCOUNT.LAST_UPDATE_DATE
  is '最后更新时间';
comment on column MERCHANT_DEBIT_ACCOUNT.CREATOR
  is '创建人';
comment on column MERCHANT_DEBIT_ACCOUNT.CREATE_DATE
  is '创建时间';
comment on column MERCHANT_DEBIT_ACCOUNT.SIGN
  is '签名';
comment on column MERCHANT_DEBIT_ACCOUNT.VERSION
  is '版本';
comment on column MERCHANT_DEBIT_ACCOUNT.HISTORY_ID
  is '流水号';
alter table MERCHANT_DEBIT_ACCOUNT
  add primary key (ACCOUNT_ID);
...
create table SYSTEM_DEBIT_ACCOUNT0
(
  ACCOUNT_ID           NUMBER not null,
  STATUS               VARCHAR2(10),
  AVAILABLE_BALANCE    VARCHAR2(30),
...
comment on column SYSTEM_DEBIT_ACCOUNT0.ACCOUNT_ID
  is '账户ID';
comment on column SYSTEM_DEBIT_ACCOUNT0.STATUS
  is '状态';
comment on column SYSTEM_DEBIT_ACCOUNT0.AVAILABLE_BALANCE
  is '可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT0.UNAVAILABLE_BANLANCE
  is '不可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT0.CREDITABLE_BANLANCE
  is '授信余额';
comment on column SYSTEM_DEBIT_ACCOUNT0.ACCOUNT_TYPE_ID
  is '账户类型ID';
comment on column SYSTEM_DEBIT_ACCOUNT0.RMK
  is '备注';
comment on column SYSTEM_DEBIT_ACCOUNT0.LAST_UPDATE_USER
  is '最后更新人';
comment on column SYSTEM_DEBIT_ACCOUNT0.LAST_UPDATE_DATE
  is '最后更新时间';
comment on column SYSTEM_DEBIT_ACCOUNT0.CREATOR
  is '创建人';
comment on column SYSTEM_DEBIT_ACCOUNT0.CREATE_DATE
  is '创建时间';
comment on column SYSTEM_DEBIT_ACCOUNT0.SIGN
  is '签名';
comment on column SYSTEM_DEBIT_ACCOUNT0.VERSION
  is '版本';
comment on column SYSTEM_DEBIT_ACCOUNT0.HISTORY_ID
  is '流水号';
alter table SYSTEM_DEBIT_ACCOUNT0
  add primary key (ACCOUNT_ID);

create table SYSTEM_DEBIT_ACCOUNT1
(
  ACCOUNT_ID           NUMBER not null,
  STATUS               VARCHAR2(10),
  AVAILABLE_BALANCE    VARCHAR2(30),
...
comment on column SYSTEM_DEBIT_ACCOUNT1.ACCOUNT_ID
  is '账户ID';
comment on column SYSTEM_DEBIT_ACCOUNT1.STATUS
  is '状态';
comment on column SYSTEM_DEBIT_ACCOUNT1.AVAILABLE_BALANCE
  is '可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT1.UNAVAILABLE_BANLANCE
  is '不可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT1.CREDITABLE_BANLANCE
  is '授信余额';
comment on column SYSTEM_DEBIT_ACCOUNT1.ACCOUNT_TYPE_ID
  is '账户类型ID';
comment on column SYSTEM_DEBIT_ACCOUNT1.RMK
  is '备注';
comment on column SYSTEM_DEBIT_ACCOUNT1.LAST_UPDATE_USER
  is '最后更新人';
comment on column SYSTEM_DEBIT_ACCOUNT1.LAST_UPDATE_DATE
  is '最后更新时间';
comment on column SYSTEM_DEBIT_ACCOUNT1.CREATOR
  is '创建人';
comment on column SYSTEM_DEBIT_ACCOUNT1.CREATE_DATE
  is '创建时间';
comment on column SYSTEM_DEBIT_ACCOUNT1.SIGN
  is '签名';
comment on column SYSTEM_DEBIT_ACCOUNT1.VERSION
  is '版本';
comment on column SYSTEM_DEBIT_ACCOUNT1.HISTORY_ID
  is '流水号';
alter table SYSTEM_DEBIT_ACCOUNT1
  add primary key (ACCOUNT_ID);

create table SYSTEM_DEBIT_ACCOUNT2
(
  ACCOUNT_ID           NUMBER not null,
  STATUS               VARCHAR2(10),
  AVAILABLE_BALANCE    VARCHAR2(30),
...
comment on column SYSTEM_DEBIT_ACCOUNT2.ACCOUNT_ID
  is '账户ID';
comment on column SYSTEM_DEBIT_ACCOUNT2.STATUS
  is '状态';
comment on column SYSTEM_DEBIT_ACCOUNT2.AVAILABLE_BALANCE
  is '可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT2.UNAVAILABLE_BANLANCE
  is '不可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT2.CREDITABLE_BANLANCE
  is '授信余额';
comment on column SYSTEM_DEBIT_ACCOUNT2.ACCOUNT_TYPE_ID
  is '账户类型ID';
comment on column SYSTEM_DEBIT_ACCOUNT2.RMK
  is '备注';
comment on column SYSTEM_DEBIT_ACCOUNT2.LAST_UPDATE_USER
  is '最后更新人';
comment on column SYSTEM_DEBIT_ACCOUNT2.LAST_UPDATE_DATE
  is '最后更新时间';
comment on column SYSTEM_DEBIT_ACCOUNT2.CREATOR
  is '创建人';
comment on column SYSTEM_DEBIT_ACCOUNT2.CREATE_DATE
  is '创建时间';
comment on column SYSTEM_DEBIT_ACCOUNT2.SIGN
  is '签名';
comment on column SYSTEM_DEBIT_ACCOUNT2.VERSION
  is '版本';
comment on column SYSTEM_DEBIT_ACCOUNT2.HISTORY_ID
  is '流水号';
alter table SYSTEM_DEBIT_ACCOUNT2
  add primary key (ACCOUNT_ID);

create table SYSTEM_DEBIT_ACCOUNT3
(
  ACCOUNT_ID           NUMBER not null,
  STATUS               VARCHAR2(10),
  AVAILABLE_BALANCE    VARCHAR2(30),
...
comment on column SYSTEM_DEBIT_ACCOUNT3.ACCOUNT_ID
  is '账户ID';
comment on column SYSTEM_DEBIT_ACCOUNT3.STATUS
  is '状态';
comment on column SYSTEM_DEBIT_ACCOUNT3.AVAILABLE_BALANCE
  is '可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT3.UNAVAILABLE_BANLANCE
  is '不可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT3.CREDITABLE_BANLANCE
  is '授信余额';
comment on column SYSTEM_DEBIT_ACCOUNT3.ACCOUNT_TYPE_ID
  is '账户类型ID';
comment on column SYSTEM_DEBIT_ACCOUNT3.RMK
  is '备注';
comment on column SYSTEM_DEBIT_ACCOUNT3.LAST_UPDATE_USER
  is '最后更新人';
comment on column SYSTEM_DEBIT_ACCOUNT3.LAST_UPDATE_DATE
  is '最后更新时间';
comment on column SYSTEM_DEBIT_ACCOUNT3.CREATOR
  is '创建人';
comment on column SYSTEM_DEBIT_ACCOUNT3.CREATE_DATE
  is '创建时间';
comment on column SYSTEM_DEBIT_ACCOUNT3.SIGN
  is '签名';
comment on column SYSTEM_DEBIT_ACCOUNT3.VERSION
  is '版本';
comment on column SYSTEM_DEBIT_ACCOUNT3.HISTORY_ID
  is '流水号';
alter table SYSTEM_DEBIT_ACCOUNT3
  add primary key (ACCOUNT_ID);

create table SYSTEM_DEBIT_ACCOUNT4
(
  ACCOUNT_ID           NUMBER not null,
  STATUS               VARCHAR2(10),
  AVAILABLE_BALANCE    VARCHAR2(30),
...
comment on column SYSTEM_DEBIT_ACCOUNT4.ACCOUNT_ID
  is '账户ID';
comment on column SYSTEM_DEBIT_ACCOUNT4.STATUS
  is '状态';
comment on column SYSTEM_DEBIT_ACCOUNT4.AVAILABLE_BALANCE
  is '可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT4.UNAVAILABLE_BANLANCE
  is '不可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT4.CREDITABLE_BANLANCE
  is '授信余额';
comment on column SYSTEM_DEBIT_ACCOUNT4.ACCOUNT_TYPE_ID
  is '账户类型ID';
comment on column SYSTEM_DEBIT_ACCOUNT4.RMK
  is '备注';
comment on column SYSTEM_DEBIT_ACCOUNT4.LAST_UPDATE_USER
  is '最后更新人';
comment on column SYSTEM_DEBIT_ACCOUNT4.LAST_UPDATE_DATE
  is '最后更新时间';
comment on column SYSTEM_DEBIT_ACCOUNT4.CREATOR
  is '创建人';
comment on column SYSTEM_DEBIT_ACCOUNT4.CREATE_DATE
  is '创建时间';
comment on column SYSTEM_DEBIT_ACCOUNT4.SIGN
  is '签名';
comment on column SYSTEM_DEBIT_ACCOUNT4.VERSION
  is '版本';
comment on column SYSTEM_DEBIT_ACCOUNT4.HISTORY_ID
  is '流水号';
alter table SYSTEM_DEBIT_ACCOUNT4
  add primary key (ACCOUNT_ID);

create table SYSTEM_DEBIT_ACCOUNT5
(
  ACCOUNT_ID           NUMBER not null,
  STATUS               VARCHAR2(10),
  AVAILABLE_BALANCE    VARCHAR2(30),
...
comment on column SYSTEM_DEBIT_ACCOUNT5.ACCOUNT_ID
  is '账户ID';
comment on column SYSTEM_DEBIT_ACCOUNT5.STATUS
  is '状态';
comment on column SYSTEM_DEBIT_ACCOUNT5.AVAILABLE_BALANCE
  is '可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT5.UNAVAILABLE_BANLANCE
  is '不可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT5.CREDITABLE_BANLANCE
  is '授信余额';
comment on column SYSTEM_DEBIT_ACCOUNT5.ACCOUNT_TYPE_ID
  is '账户类型ID';
comment on column SYSTEM_DEBIT_ACCOUNT5.RMK
  is '备注';
comment on column SYSTEM_DEBIT_ACCOUNT5.LAST_UPDATE_USER
  is '最后更新人';
comment on column SYSTEM_DEBIT_ACCOUNT5.LAST_UPDATE_DATE
  is '最后更新时间';
comment on column SYSTEM_DEBIT_ACCOUNT5.CREATOR
  is '创建人';
comment on column SYSTEM_DEBIT_ACCOUNT5.CREATE_DATE
  is '创建时间';
comment on column SYSTEM_DEBIT_ACCOUNT5.SIGN
  is '签名';
comment on column SYSTEM_DEBIT_ACCOUNT5.VERSION
  is '版本';
comment on column SYSTEM_DEBIT_ACCOUNT5.HISTORY_ID
  is '流水号';
alter table SYSTEM_DEBIT_ACCOUNT5
  add primary key (ACCOUNT_ID);

create table SYSTEM_DEBIT_ACCOUNT6
(
  ACCOUNT_ID           NUMBER not null,
  STATUS               VARCHAR2(10),
  AVAILABLE_BALANCE    VARCHAR2(30),
...
comment on column SYSTEM_DEBIT_ACCOUNT6.ACCOUNT_ID
  is '账户ID';
comment on column SYSTEM_DEBIT_ACCOUNT6.STATUS
  is '状态';
comment on column SYSTEM_DEBIT_ACCOUNT6.AVAILABLE_BALANCE
  is '可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT6.UNAVAILABLE_BANLANCE
  is '不可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT6.CREDITABLE_BANLANCE
  is '授信余额';
comment on column SYSTEM_DEBIT_ACCOUNT6.ACCOUNT_TYPE_ID
  is '账户类型ID';
comment on column SYSTEM_DEBIT_ACCOUNT6.RMK
  is '备注';
comment on column SYSTEM_DEBIT_ACCOUNT6.LAST_UPDATE_USER
  is '最后更新人';
comment on column SYSTEM_DEBIT_ACCOUNT6.LAST_UPDATE_DATE
  is '最后更新时间';
comment on column SYSTEM_DEBIT_ACCOUNT6.CREATOR
  is '创建人';
comment on column SYSTEM_DEBIT_ACCOUNT6.CREATE_DATE
  is '创建时间';
comment on column SYSTEM_DEBIT_ACCOUNT6.SIGN
  is '签名';
comment on column SYSTEM_DEBIT_ACCOUNT6.VERSION
  is '版本';
comment on column SYSTEM_DEBIT_ACCOUNT6.HISTORY_ID
  is '流水号';
alter table SYSTEM_DEBIT_ACCOUNT6
  add primary key (ACCOUNT_ID);

create table SYSTEM_DEBIT_ACCOUNT7
(
  ACCOUNT_ID           NUMBER not null,
  STATUS               VARCHAR2(10),
  AVAILABLE_BALANCE    VARCHAR2(30),
...
comment on column SYSTEM_DEBIT_ACCOUNT7.ACCOUNT_ID
  is '账户ID';
comment on column SYSTEM_DEBIT_ACCOUNT7.STATUS
  is '状态';
comment on column SYSTEM_DEBIT_ACCOUNT7.AVAILABLE_BALANCE
  is '可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT7.UNAVAILABLE_BANLANCE
  is '不可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT7.CREDITABLE_BANLANCE
  is '授信余额';
comment on column SYSTEM_DEBIT_ACCOUNT7.ACCOUNT_TYPE_ID
  is '账户类型ID';
comment on column SYSTEM_DEBIT_ACCOUNT7.RMK
  is '备注';
comment on column SYSTEM_DEBIT_ACCOUNT7.LAST_UPDATE_USER
  is '最后更新人';
comment on column SYSTEM_DEBIT_ACCOUNT7.LAST_UPDATE_DATE
  is '最后更新时间';
comment on column SYSTEM_DEBIT_ACCOUNT7.CREATOR
  is '创建人';
comment on column SYSTEM_DEBIT_ACCOUNT7.CREATE_DATE
  is '创建时间';
comment on column SYSTEM_DEBIT_ACCOUNT7.SIGN
  is '签名';
comment on column SYSTEM_DEBIT_ACCOUNT7.VERSION
  is '版本';
comment on column SYSTEM_DEBIT_ACCOUNT7.HISTORY_ID
  is '流水号';
alter table SYSTEM_DEBIT_ACCOUNT7
  add primary key (ACCOUNT_ID);

create table SYSTEM_DEBIT_ACCOUNT8
(
  ACCOUNT_ID           NUMBER not null,
  STATUS               VARCHAR2(10),
  AVAILABLE_BALANCE    VARCHAR2(30),
...
comment on column SYSTEM_DEBIT_ACCOUNT8.ACCOUNT_ID
  is '账户ID';
comment on column SYSTEM_DEBIT_ACCOUNT8.STATUS
  is '状态';
comment on column SYSTEM_DEBIT_ACCOUNT8.AVAILABLE_BALANCE
  is '可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT8.UNAVAILABLE_BANLANCE
  is '不可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT8.CREDITABLE_BANLANCE
  is '授信余额';
comment on column SYSTEM_DEBIT_ACCOUNT8.ACCOUNT_TYPE_ID
  is '账户类型ID';
comment on column SYSTEM_DEBIT_ACCOUNT8.RMK
  is '备注';
comment on column SYSTEM_DEBIT_ACCOUNT8.LAST_UPDATE_USER
  is '最后更新人';
comment on column SYSTEM_DEBIT_ACCOUNT8.LAST_UPDATE_DATE
  is '最后更新时间';
comment on column SYSTEM_DEBIT_ACCOUNT8.CREATOR
  is '创建人';
comment on column SYSTEM_DEBIT_ACCOUNT8.CREATE_DATE
  is '创建时间';
comment on column SYSTEM_DEBIT_ACCOUNT8.SIGN
  is '签名';
comment on column SYSTEM_DEBIT_ACCOUNT8.VERSION
  is '版本';
comment on column SYSTEM_DEBIT_ACCOUNT8.HISTORY_ID
  is '流水号';
alter table SYSTEM_DEBIT_ACCOUNT8
  add primary key (ACCOUNT_ID);

create table SYSTEM_DEBIT_ACCOUNT9
(
  ACCOUNT_ID           NUMBER not null,
  STATUS               VARCHAR2(10),
  AVAILABLE_BALANCE    VARCHAR2(30),
...
comment on column SYSTEM_DEBIT_ACCOUNT9.ACCOUNT_ID
  is '账户ID';
comment on column SYSTEM_DEBIT_ACCOUNT9.STATUS
  is '状态';
comment on column SYSTEM_DEBIT_ACCOUNT9.AVAILABLE_BALANCE
  is '可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT9.UNAVAILABLE_BANLANCE
  is '不可用余额';
comment on column SYSTEM_DEBIT_ACCOUNT9.CREDITABLE_BANLANCE
  is '授信余额';
comment on column SYSTEM_DEBIT_ACCOUNT9.ACCOUNT_TYPE_ID
  is '账户类型ID';
comment on column SYSTEM_DEBIT_ACCOUNT9.RMK
  is '备注';
comment on column SYSTEM_DEBIT_ACCOUNT9.LAST_UPDATE_USER
  is '最后更新人';
comment on column SYSTEM_DEBIT_ACCOUNT9.LAST_UPDATE_DATE
  is '最后更新时间';
comment on column SYSTEM_DEBIT_ACCOUNT9.CREATOR
  is '创建人';
comment on column SYSTEM_DEBIT_ACCOUNT9.CREATE_DATE
  is '创建时间';
comment on column SYSTEM_DEBIT_ACCOUNT9.SIGN
  is '签名';
comment on column SYSTEM_DEBIT_ACCOUNT9.VERSION
  is '版本';
comment on column SYSTEM_DEBIT_ACCOUNT9.HISTORY_ID
  is '流水号';
alter table SYSTEM_DEBIT_ACCOUNT9
  add primary key (ACCOUNT_ID);
...
(
  ...
  PAYER_ACC_TYPE_ID   VARCHAR2(10),
  PAYEE_ACCOUNT_ID    NUMBER,
  PAYEE_ACC_TYPE_ID   NUMBER,
  AMT                 NUMBER,
  DESC_STR            VARCHAR2(800),
  CREATE_DATE         DATE,
  CREATOR             VARCHAR2(32),
...
comment on column TRANSACTION_HISTORY.PAYER_ACCOUNT_ID
  is '账户A ID';
comment on column TRANSACTION_HISTORY.PAYER_ACC_TYPE_ID
  is '账户A类型';
comment on column TRANSACTION_HISTORY.PAYEE_ACCOUNT_ID
  is '账户B ID';
comment on column TRANSACTION_HISTORY.PAYEE_ACC_TYPE_ID
  is '账户B类型';
...
--update table CCY_ACCOUNT_ADD_CASH_RECORD
...
comment on column CCY_ACCOUNT_ADD_CASH_RECORD.VERIFY_TIME
  is '审核日期';
comment on column CCY_ACCOUNT_ADD_CASH_RECORD.APPLY_AMT
  is '申请加款金额';
...
comment on column CCY_ACCOUNT_ADD_CASH_RECORD.RMK
  is '备注';
comment on column CCY_ACCOUNT_ADD_CASH_RECORD.SUCCESS_AMT
  is '审核成功金额';
