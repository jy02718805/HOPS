package com.yuecheng.hops.mportal.vo.order;
...
public class OrderVO
{
    ...
    public String preSuccessStatus;
    ...
    public String getDownMerchant()
    {
        return downMerchant;
    }

    public void setDownMerchant(String downMerchant)
    {
        this.downMerchant = downMerchant;
    }
