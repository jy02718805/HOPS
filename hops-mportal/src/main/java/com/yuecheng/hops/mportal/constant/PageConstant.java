package com.yuecheng.hops.mportal.constant;
...
public class PageConstant
{
    ...
    // 指定排除配置页面
    public static final String PAGE_ASSIGN_EXCLUDE_ADD_PRODUCT = "transaction/assignexclude_add_product.ftl";
    ...
    // 黑名单增加页面
    public static final String PAGE_BLACKLIST_ADD = "identity/blacklist/blacklist_add.ftl";

    // 黑名单列表页面
    public static final String PAGE_BLACKLIST_LIST = "identity/blacklist/blacklist_list.ftl";

    // 黑名单编辑页面
    public static final String PAGE_BLACKLIST_EDIT = "identity/blacklist/blacklist_edit.ftl";

    // 黑名单详情页面
    public static final String PAGE_BLACKLIST_VIEW = "identity/blacklist/blacklist_view.ftl";
