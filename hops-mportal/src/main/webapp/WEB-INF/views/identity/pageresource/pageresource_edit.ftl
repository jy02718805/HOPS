	...
	<form id="inputForm" action="edit"  method="post" >
		<table class="input">
			<tr>
				...
				<td>
					<input type="hidden" id="resourceId" name="resourceId" class="ipt" maxlength="200" value="${(id)!""}"/>
					<input type="text" id="pageResourceName" name="pageResourceName" class="ipt" maxlength="30" value="${(pageResource.pageResourceName)!""}"/>	 
				</td>
			</tr>
			<tr>
				<th>
				...
				<td>
					<input type="text" id="pageUrl" name="pageUrl" class="ipt" maxlength="200" value="${(pageResource.pageUrl)!""}"/>	 
				</td>
			</tr>
			<tr>
				<th>
