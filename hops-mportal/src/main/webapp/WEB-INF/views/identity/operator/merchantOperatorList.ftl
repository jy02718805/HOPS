	    ...
	    <input id=page type=hidden name=page> 
								 <span id= "ownerIdentityIdfiled">
								  ...
								  <input type="submit" class="button" value="查&nbsp;&nbsp;询" />
								    ...
								    <@shiro.hasPermission name="moperator:add_view">
  ...
  <tbody>
    ...
    <#list mlist as list>
	  <tr>
		    ...
		    <td>
	    <@shiro.hasPermission name="moperator:changestatus_view">
	    <#if list.identityStatus??>
				          <#if list.identityStatus.status =='1'>
	    ...
	    <@shiro.hasPermission name="moperator:edit_view">
	    	<A href="edit?oid=${list.id}">[编辑]</A>
	    </@shiro.hasPermission>
	    <@shiro.hasPermission name="moperator:changepwd_view">
			<A href="toModifyPassword?id=${list.id}">[修改用户密码]</A>
		</@shiro.hasPermission>
		<@shiro.hasPermission name="moperator:addrolse_view">
			<A href="tosetrole?oid=${list.id}&source=merchantOperator">[设置角色]</A>
		</@shiro.hasPermission>
