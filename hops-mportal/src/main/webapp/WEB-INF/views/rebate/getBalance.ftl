...
<body>
<div class="mg10"></div>
	<form id="inputForm" action="getBalance"  method="post">
		<table class="input">
			<tr>
				<th>发生商户:</th>
			...
			<tr>
				<th>实际金额:</th>
				<td>
				${(rebateRecordHistory.rebateRecordHistory.actulAmount?string("0.0000"))!""}
			   </td>
				<th>余额</th>
				<td>
				${(rebateRecordHistory.rebateRecordHistory.balance?string("0.0000"))!""}
			   </td>
			</tr>
		</table>
		<table class="input" >	
			<tr>
				...
				<td>
					<input type="submit" class="button" value="确定收回"/>
				</td>
			</tr>
		</table>
	</form>
