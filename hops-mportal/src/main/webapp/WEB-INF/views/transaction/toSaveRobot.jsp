...
<head>
	...
	function saveRobot(){
		...
		var merchantId_select_text=$("#merchantId_select").find("option:selected").text();
		var classPath = $("#classPath").val();
		if(merchantId_select != null && classPath.length > 0){
			$("#merchantId").val(merchantId_select);
			$("#merchantName").val(merchantId_select_text);
			$('#inputForm').attr("action", "${ctx}/transaction/doSaveRobot");
			$('#inputForm').submit();
		}
	}
	</script>
		...
		<fieldset>
			...
			<div class="control-group">
				...
				<div class="controls">
					...
					<input type="hidden" id="merchantName" name="merchantName" class="input-large required" minlength="0"/>
			...
			<div class="control-group">
				...
				<div class="controls">
					<input type="text" id="classPath" name="classPath" class="ipt required" minlength="0"/>
				</div>
			</div>
