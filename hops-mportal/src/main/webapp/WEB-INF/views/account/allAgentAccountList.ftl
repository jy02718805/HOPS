...
<BODY>
<FORM id="listForm" method="post" action="allAgentAccountList">
...
<TABLE id="listTable" class="list">
  ...
  <TR>
    ...
    <TH><A class="sort" href="javascript:;" name="consignee">账户类型名称</A> </TH>
    <TH><A class="sort" href="javascript:;" name="member">详情</A> </TH>
    <TH><A class="sort" href="javascript:;" name="consignee">币种</A> </TH>
    <TH><A class="sort" href="javascript:;" name="member">账户状态</A> </TH>
     ...
     <#if (accountlist?size>0)>
    		<#list accountlist as account>
				<tr>
					...
					<@shiro.hasPermission name="agentAccount:block_show">   
						...
						<#if account.status =='1'>
							...
							<@shiro.hasPermission name="agentAccount:debitCurrency_show">
							...
							<@shiro.hasPermission name="agentAccount:creditCurrency_show">
							...
							<@shiro.hasPermission name="agentAccount:debitCreditable_show">
							...
							<@shiro.hasPermission name="agentAccount:creditCreditable_show">
					...
					<@shiro.hasPermission name="agentAccount:view_logs">
