...
<div class="mg10"></div>
	<form id="inputForm" action="${base}/account/doCurrencyAccountCredit"  method="post">
		<input type="hidden" id="accountId" name="accountId" value="${ca.accountType.accountTypeId}"/>
		...
		<tr>
				...
				<td>
					<input type="text" id="merchantName" name="merchantName" disabled="disabled" class="ipt" maxlength="200" value="${identityName!""}"/>	 
				</td>
			</tr>
			<tr>
				<th>
			...
			<tr>
				...
				<td>
					<input type="text" id="accountId" name="accountId" disabled="disabled" class="ipt" maxlength="200" value="${ca.availableBalance?string("0.0000")}"/>	 
			...
			<tr>
				...
				<td>
					<input type="text" id="accountId" name="accountId" disabled="disabled" class="ipt" maxlength="200" value="${ca.unavailableBanlance?string("0.0000")}"/>	 
			...
			<tr>
				...
				<td>
					<input type="text" id="accountId" name="accountId" disabled="disabled" class="ipt" maxlength="200" value="${ca.creditableBanlance?string("0.0000")}"/>	 
