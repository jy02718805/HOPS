...
<body>
	<form id='listForm' method='post' action="${base}/report/transactionReports">
	 ...
	 <script type="text/javascript" language="javascript"> 
		...
		PageClick = function(pageclickednumber) { 
			...
			$("#page").val(pageclickednumber);
		   	$("#listForm").attr("action","${base}/report/transactionReports").submit();
		...
		function exportTransactionExport(){
			...
			$("#listForm").attr("action","${base}/report/transactionExport").submit();
		}
