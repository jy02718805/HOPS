...
<body>
	<form id='listForm' method='post' action="${base}/report/agentTransactionReports">
		...
		<div class="line_bar"> 
			...
			<div style="float:right;">
				 <@shiro.user>
				<input type="button" class="button" onclick="queryTransactionReports();"  value="查询" class="button"/>
				</@shiro.user>
				<@shiro.hasPermission name="transactionReport:export_show">
				<input type="button" class="button" onclick="exportTransactionExport();"  value="导出Excel" class="button"/>
				</@shiro.hasPermission>
			</div>
			</div>
			<div class="line_bar">
	 ...
	 <script type="text/javascript" language="javascript"> 
		...
		PageClick = function(pageclickednumber) { 
			...
			$("#page").val(pageclickednumber);
		   	$("#listForm").attr("action","${base}/report/agentTransactionReports").submit();
		}
		...
		function exportTransactionExport(){
			...
			$("#listForm").attr("action","${base}/report/agentTransactionExport").submit();
			$("#listForm").attr("action","transactionReports");
		}
