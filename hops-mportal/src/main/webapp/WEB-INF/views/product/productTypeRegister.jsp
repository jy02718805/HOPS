...
<div class="mg10"></div>
	<form action="${ctx}/product/saveProductType" id="inputForm" method="post">
		<input type="hidden" name="beans" id="beans">
		<div>
			产品类型名称：<input type="text" value="" id="productTypeName" name="productTypeName" class="ipt"/>
		</div>
		<div>
...
<%-- 								<textarea rows="2" cols="100" readonly="readonly">${productProperty.value}</textarea> --%>
		    ...
		    <div style="border:2px; 
		                ...
		                margin-left:20%;
		                margin-top:20px">
		        <input type="button" value="提交" onclick="saveProductType()"/>
		    </div>
	    </div>
	</form>
