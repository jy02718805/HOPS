...
<body class="b9c">
<div class="mg-wrap">
<div class="mg-header pt-bgco">
<h1 class="ptlogo fl"><a href="#"><img src="${base}/template/admin/images/pt-login-logo.png" /></a></h1>
<dl class="status fr">
...
<dd><i class="status-out"></i><a href="${base}/login/loginout" target="_top">退出</a></dd>
 ...
 <div class="g-sd1 b9c">
        ...
        <div class="sub-menu-title pt-bgco"  id="topmenuname"><strong>订单管理</strong></div>
        <div id=menu >
    ...
    <div class="g-mn1">
        ...
        <#list menulist0 as list0>
      	<#if list0.status=="0">
		        <LI>
		        	<a href="#${list0.menu.pageResource.pageUrl!""}" title="${list0.menu.menuName}"><i class="mg-menu-pt-ico mg-menu-ico${list0_index+1}"></i>${list0.menu.menuName}</a>
		        </LI>
		</#if>
	  </#list>
