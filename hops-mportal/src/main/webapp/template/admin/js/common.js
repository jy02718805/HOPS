...
function formatCurrency(num) {
	if (null == num || num == "" || num == " " || num == undefined) {
		return '';
	}
...
function OnInput(event) {
	document.getElementById('displayVlaue').innerHTML = formatCurrency(event.srcElement.value)
			+ "  " + digitUppercase(event.srcElement.value);
