	...
	<form id="inputForm" action="edit"  method="post">
		<table class="input">
			...
			<tr>
				<th>用户名:</th>
				<td>
					  ${(operator.person.userName)!""}
			   </td>
			</tr>
	        <tr>
				<th><span class="requiredField">*</span>姓名:</th>
				<td>
					<input type="text" id="displayName" name="person.displayName" class="text" maxlength="200" value="${(operator.person.displayName)!""}" />	
			   </td>
			</tr>
			...
			<tr>
				...
				<td>
						<input  class="Wdate" type="text" onClick="WdatePicker()"  id="birthday" name="person.birthday" value=${(operator.person.birthday)!""} class="text" maxlength="200" />
				</td>
			</tr>
				...
				<td>
				   <input type=hidden name="id" value="${(operator.id)!""}"/>
					...
					<input type="button" class="button" value="返&nbsp;&nbsp;回" onclick="location.href='${base}/Operator/list'" />
				</td>
			</tr>
		</table>
	</form>
