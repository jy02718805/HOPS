...
@Service("manualCloserSuccessOrderProcess")
public class ManualCloserSuccessOrderProcessImpl implements ManualCloserSuccessOrderProcess
{
    @Autowired
    ...
    public void execute()
    {
        deliveryStatusFailAction.handleRequest();//order
        orderStatusFailAction.handleRequest();//order errorCode
