...
@Service("queryStartUpProcess")
public class QueryStartUpProcessImpl implements QueryStartUpProcess
{
    @Autowired
    ...
    @Autowired
    @Qualifier("queryStatusQueryingAction") 
    private AbstractEventAction queryStatusQueryingAction;
    ...
    public void execute()
    {
        ...
        queryStatusQueryingAction.handleRequest();
