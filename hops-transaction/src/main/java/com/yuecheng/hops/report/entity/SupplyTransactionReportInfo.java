...
@Entity
@Table(name = "supply_transaction_report")
public class SupplyTransactionReportInfo implements Serializable
{
    /**
	 * 
	 */
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "supplyReportIdSeq")
    @SequenceGenerator(name = "supplyReportIdSeq", sequenceName = "supply_report_id_seq")
    @Column(name = "supply_transaction_report_id")
    private Long supplyTransactionReportId;
    ...
    @Column(name = "supply_transaction_num")
    ...
    public Long getSupplyTransactionReportId()
    {
        return supplyTransactionReportId;
    }

    public void setSupplyTransactionReportId(Long supplyTransactionReportId)
    {
        this.supplyTransactionReportId = supplyTransactionReportId;
    }
