...
public interface AccountReportRecordDao
{
    AccountReportRecord queryAccountReportRecord(Date imputationDate);

    AccountReportRecord queryAccountReportRecordByStatus(Date imputationDate);
}
